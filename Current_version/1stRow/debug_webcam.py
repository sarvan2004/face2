...
while cap.isOpened():
            ...
            if is_inside_polygon(face_center_x, face_center_y, polygon_roi):
                ...
                try:
                    ...
                    if face_id_key not in face_embeddings_cache:
                        print(f"🔍 Attempting to recognize face {faces_detected}...")
                        ...
                        if isinstance(verification, list) and len(verification) > 0 and not verification[0].empty:
                            ...
                            print(f"✅ Recognized: {person_name} (distance: {distance:.4f})")
                            faces_recognized += 1
                            ...
                            print(f"❌ No match found for face {faces_detected}")
    ...
    cv2.imshow("Face Recognition Debug - Webcam", frame)
